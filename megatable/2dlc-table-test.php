	...
	<div class="site-content" id="content" role="main">
		<section class="page-wrapper">
			<div class="container">
				...
				<br><a data-toggle="modal" href="#ref1"><i class="fa fa-file-text-o" style="color:black; vertical-align: bottom"></i></a>
				<!-- Modal -->
...
?>
				...
				<br><a tabindex="0" role="button" data-toggle="popover" data-placement="top" data-trigger="focus" data-content="Suitable for separations of proteins."><img class="fl-rgt" src="img/plm-s.png" width="25" alt=""/></a></td>
