...
$con=mysqli_connect("localhost","pirokana","PrKAn03","pirokana");
 ...
 if (mysqli_connect_errno())
   ...
   // Insert form fields
    $sql="INSERT INTO 2DLC (application, category, coupling, mode, modulation, one_d, two_d, detection, remarks, ref, author, year, title)
...
header("Location: insertdata-2D-LC.html");
 mysqli_close($con);
 ?> 
