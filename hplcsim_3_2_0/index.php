...
<html>
	<head>
		...
		content="1; url=http://multidlc.org/hplcsim/hplcsim.html" />
	</head>
	<body>
		<main>
			<div class="hplc-resources">
				...
				<hr>
				<h4>If you are not automatically redirected, <a href="http://multidlc.org/hplcsim/hplcsim.html">Click Here</a></h4>
			</div>
		</main>
