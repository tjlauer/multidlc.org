...
<html>
	<head>
		<?php global $tab_title; if ($tab_title) { echo '<title>' . $tab_title . '</title>'; } else { echo '<title>Multi-Dimensional Separations</title>'; } ?>
		<!--<title>Multi-Dimensional Separations</title>--> <!-- Replaced normal title tags with a dynamic PHP script that allows each page to have a custom title (Thomas Lauer, 08 June 2021) -->
		<meta charset="utf-8"/>
		<?php global $isHPLCSim; if ($isHPLCSim) { } else { echo '<link rel="stylesheet" type="text/css" href="/style.css">'; } ?>
		<!--<link rel="stylesheet" type="text/css" href="/style.css">--> <!-- Replaced this link tag with a dynamic PHP script that loads the site-wide style.css file ONLY IF the page DOES NOT declare '$isHPLCSim = true;' (Thomas Lauer, 08 June 2021) -->
					...
					<header>
						...
						<menu style="position:relative;top:-36px;">
							<ul class="cf">
								...
								<li class="unselectable" onmouseleave="menuSelect(selected_tab);hideLiteratureDropdown();">
									...
									<a class="dropdown" id="LiteratureDropdownA" onmouseover="menuSelect(3);showLiteratureDropdown();" href="../literature/2DLC-Applications" style="width:110px">Literature</a>
									<ul id="LiteratureDropdownUL">
										...
										<li>
											<a href="../literature/books">Books</a>
										</li>
									</ul>
								</li>
								...
								<li class="unselectable" onmouseleave="menuSelect(selected_tab);hideToolsDropdown();">
									...
									<?php $ToolsDropdownUL = ''; $ToolsDropdownULItemCount = 0;
										
										$ToolsDropdownUL .= '<li><a href="../hplcsim">1D-LC Simulator</a></li>'; $ToolsDropdownULItemCount += 1;
										$ToolsDropdownUL .= '<li><a href="../flow_splitting">Flow Splitting Calculator</a></li>'; $ToolsDropdownULItemCount += 1;
										//$ToolsDropdownUL .= '<li><a href="../dispersion_calculator">Dispersion Calculator</a></li>'; $ToolsDropdownULItemCount += 1;
										//$ToolsDropdownUL .= '<li><a href="../chromSimLite">chromSimLite</a></li>'; $ToolsDropdownULItemCount += 1;
										
										$ToolsDropdownULHeight = 48 * $ToolsDropdownULItemCount;
										echo '<ul id="ToolsDropdownUL" style="height: '.$ToolsDropdownULHeight.'px">';
										echo $ToolsDropdownUL;
										echo '</ul>';
									?>
								</li>
							</ul>
						...
						<script>
							function showLiteratureDropdown(){
								...
								document.getElementById("LiteratureDropdownUL").style.opacity = "1";
							...
							function showToolsDropdown(){
								...
								document.getElementById("ToolsDropdownUL").style.opacity = "1";
