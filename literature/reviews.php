...
try {
	...
	$sql = "SELECT `id`,`topic`,`category`,`subcategory`,`type`,`doi`,`author`,`year` FROM `lib_database` WHERE `type` LIKE 'Review' ORDER BY `id`";
    $q = $pdo->query($sql);
	...
	<div class="container">
		<div class="row padding-top-60 padding-bottom-60">		
			<div class="col-md-12">	
				...
				<h1 style="font-size:2em;">Reviews</h1>
				<hr>
