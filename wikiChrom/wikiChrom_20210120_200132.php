		...
		<div class="row padding-top-60 padding-bottom-60">		
			<div class="col-md-12">	
				<div class="site-content">
					...
					<button onclick="exportTable();">Export Filtered Table</button>
					<hr>
...
<script>
	function exportTable(){
		...
		var CSV_Cache = "Analyte, Abbreviation, CAS, Dataset ID, Mechanism, Manufacturer, Brand, Stationary Phase, Pore Side (A), Particle Size (µm), Solvent A, Solvent B, Composition (%B), Temperature (C), Retention Factor";
		...
		hiddenElement.href = 'data:text/csv;charset=utf-16,' + encodeURI(CSV_Cache);
		hiddenElement.target = '_blank';
		hiddenElement.download = 'wikiChrom_results.csv';
		hiddenElement.click();
	}
</script>
